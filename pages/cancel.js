...
const CancellationRefund = () => {
  ...
  const styles = `
    * {
    ...
    .refund-section a.geopulse-link {
      color: #000000;
      text-decoration: none;
      font-weight: 600;
      transition: color 0.2s ease;
    }
    .refund-section a.geopulse-link:hover {
      color: #4a5568;
        ...
        <div className="refund-wrapper">
          ...
          <main className="refund-main-content">
            <section id="overview" className="refund-section">
              <h2>Overview</h2>
              <p>
                At <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a>, we strive to provide the best map downloading and GIS services to our customers. This Cancellation and Refund Policy outlines the terms and conditions regarding cancellations, refunds, and related matters for our subscription-based services.
              </p>
              <p>
                By subscribing to <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> services, you acknowledge that you have read, understood, and agree to be bound by this policy. Please read this policy carefully before making any purchase or subscription.
              </p>
            ...
            <section id="cancellation" className="refund-section">
              ...
              <p>
                You have the right to cancel your <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> subscription at any time. Cancellations can be initiated directly from your account dashboard without the need to contact customer support.
              </p>
            ...
            <section id="refund" className="refund-section">
              ...
              <p>
                All charges for <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> services are <strong>non-refundable</strong> unless expressly stated otherwise or required by applicable law. This includes but is not limited to:
              </p>
              <ul>
              ...
              <ul>
                <li><strong>Technical Issues:</strong> If <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> experiences prolonged service outages or technical problems that prevent you from using the service for an extended period, and we are unable to resolve the issue in a reasonable timeframe</li>
            ...
            <section id="subscription" className="refund-section">
              ...
              <p>
                <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> offers various billing cycles to suit your needs:
              </p>
              <ul>
              ...
              <h3>Price Changes</h3>
              <p>
                <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> reserves the right to change subscription prices. However:
              </p>
              <ul>
            ...
            <section id="trial" className="refund-section">
              ...
              <h3>Trial Period</h3>
              <p>
                <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> may offer free trial periods for new customers to test our services. During the trial period:
              </p>
              <ul>
            ...
            <section id="downgrades" className="refund-section">
              ...
              <div className="refund-highlight">
                <p><strong>Warning:</strong> <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> is not liable for any data loss resulting from a downgrade. Please ensure you backup or export any important data before downgrading.</p>
              </div>
              <h3>Upgrades</h3>
              <p>
            ...
            <section id="data-deletion" className="refund-section">
              ...
              <p>
                When you cancel your <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> subscription:
              </p>
              <ul>
              ...
              <ul>
                ...
                <li>Understanding that <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> is not a data archiving service</li>
              </ul>
            </section>
            <section id="exceptions" className="refund-section">
              ...
              <ul>
                ...
                <li>Service failures that substantially impair your ability to use <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a></li>
