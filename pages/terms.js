...
const TermsOfService = () => {
  ...
  const styles = `
    * {
    ...
    .tos-section a.geopulse-link {
      color: #000000;
      text-decoration: none;
      font-weight: 600;
      transition: color 0.2s ease;
    }
    .tos-section a.geopulse-link:hover {
      color: #4a5568;
      ...
      <div className="tos-container">
        <div className="tos-wrapper">
          ...
          <main className="tos-main-content">
            <section id="definitions" className="tos-section">
              ...
              <div className="tos-definition">
                <p><strong>"us", "we", or "our"</strong>: <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a></p>
              </div>
              ...
              <div className="tos-definition">
                <p><strong>"Services"</strong>: means the services provided by <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> as set out in an Order Form and the service accessible at the <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> platform</p>
              </div>
            ...
            <section id="accounts" className="tos-section">
              ...
              <p>You are responsible for safeguarding the password that you use to access the Services and for any activities or actions under your password, whether your password is with our Services or a third-party service. <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> cannot and will not be liable for any loss or damage from your failure to comply with this security obligation.</p>
              ...
              <ul>
                ...
                <li>Modify, adapt or hack the Services or modify another website so as to falsely imply that it is associated with the Services, <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a>, or any other <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> service</li>
                <li>Reproduce, duplicate, copy, sell, resell or exploit with malicious intent any portion of the Services, use of the Services, or access to the Services without the express written permission by <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a></li>
              </ul>
              <p>Verbal, physical, written or other abuse (including threats of abuse or retribution) of any customer, employee, member, or officer of <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> will result in immediate Account termination.</p>
            ...
            <section id="partners" className="tos-section">
              <h2>Partners</h2>
              <p>A "Partner" is an individual or entity that has agreed to these Terms of Service and participates in the <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> Partner Program.</p>
              ...
              <ul>
                ...
                <li>Agree that this Agreement may be changed by <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> at any time</li>
                <li>Acknowledge and agree to <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a>'s Privacy Policy</li>
                <li>Not use <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a>'s trademarks as part of its name or brand unless permitted under these Terms</li>
                <li>Not buy search engine advertising, trademarks or domain names that mention or use "<a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a>" or other <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> logos</li>
              </ul>
              <h3>Termination</h3>
              <p>Either <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> or Partner can end this agreement at any time by providing notice to the other. If there is fraud or any other unacceptable behaviour by Partner, or if Partner violates these Terms of Service, <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> can suspend Partner's privileges or end the agreement without notice. <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> can change or eliminate all or any portion of the Partner Program at any time, upon reasonable notice.</p>
              <p>All of the information, property and intellectual property you have access to as a result of your participation in the <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> Partner Program belongs entirely to <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a>.</p>
              <p>Both <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> and Partner agree to use Confidential Information and Personal Information only to perform the obligations of these Terms. Confidential Information and Personal Information must be protected and respected.</p>
            </section>
            ...
            <section id="fees" className="tos-section">
              ...
              <p><a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> shall not be liable to you or to any third party for any modification, price change, suspension, or discontinuance of the Services.</p>
            </section>
            <section id="refunds" className="tos-section">
              ...
              <h3>Downgrades</h3>
              <p>Downgrading your Services may cause the loss of User Data, features, or capacity of your Account. <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> does not accept any liability for any loss incurred as a result of downgrading.</p>
              <h3>Additional Fees</h3>
              <p><a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> is not responsible for any bank fees, interest charges, finance charges, overdraft charges, or other fees resulting from charges billed for the Services. Currency exchange settlements will be based on agreements between you and the provider of your credit card.</p>
            ...
            <section id="cancellation" className="tos-section">
              ...
              <p>You may cancel your <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> account at any time from your Account administration panel. We do not provide refunds for any remaining credit for your Subscription's Billing Cycle.</p>
              ...
              <p><a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a>, in its sole discretion, has the right to suspend or terminate your account and refuse any and all current or future use of the Services, or any other <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> Services, for any reason at any time. Upon suspension or termination, your right to use the Services will stop immediately. You may not have access to User Data that you stored on the site after we suspend or terminate your account. You are responsible for backing up User Data that you use with the Services.</p>
              <p>Termination of the Services will result in the deletion of your User Data or your access to your Account, and the forfeiture and relinquishment of all User Data in your Account. <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> reserves the right to refuse service to anyone for any reason at any time.</p>
            </section>
            <section id="liability" className="tos-section">
              <h2>Limitation of Liability</h2>
              <p>You expressly understand and agree that <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> shall not be liable for any direct, indirect, incidental, special, consequential or exemplary damages, including but not limited to, damages for loss of profits, goodwill, use, data or other intangible losses (even if <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> has been advised of the possibility of such damages), resulting from:</p>
              <ul>
            ...
            <section id="disclaimer" className="tos-section">
              ...
              <p><a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a>, its subsidiaries, affiliates, and its licensors do not warrant that:</p>
              <ul>
              ...
              <p>While <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> prohibits such conduct and User Data on the Service, you understand and agree that <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> cannot be responsible for the User Data posted on the Service and you nonetheless may be exposed to such materials.</p>
            </section>
            <section id="copyright" className="tos-section">
              ...
              <p><a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> does not pre-screen User Data, but <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> and its designee have the right (but not the obligation) in their sole discretion to refuse or remove any User Data that is available via the Service.</p>
            ...
            <section id="fair-usage" className="tos-section">
              ...
              <p>Accounts can have up to 50,000 map views per month under our fair usage policy. Customers who think their maps will exceed this level regularly should contact <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> support.</p>
            ...
            <section id="other" className="tos-section">
              ...
              <h3>Waiver</h3>
              <p>The failure of <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> to exercise or enforce any right or provision of these Terms will not constitute a waiver of such right or provision. Any waiver of any provision of these Terms will be effective only if in writing and signed by an authorized representative of <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a>.</p>
              ...
              <p><a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> reserves the right to update and change these Terms of Service from time to time without notice. Any new features that augment or enhance the current Services, including the release of new tools and resources, shall be subject to the Terms of Service. Continued use of the Service after any such changes shall constitute your consent to such changes. You can review the most current version of the Terms of Service at any time.</p>
              <h3>Indemnification</h3>
              <p>You agree to indemnify and hold harmless <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> and its respective directors, officers, employees and agents from and against any and all claims and expenses, including attorneys' fees, arising out of your use of the Services, including but not limited to your violation of the Terms.</p>
            </section>
            <section id="support" className="tos-section">
              ...
              <ul>
                <li><strong>Tier 1 (Agency Plan):</strong> Our Agency plan customers enjoy our fastest support responses, with replies typically sent within 12 hours of the request submitted through the <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> Help Centre.</li>
                <li><strong>Tier 2 (Enterprise Plan):</strong> As an Enterprise plan customer, you'll benefit from our priority support, and we aim to respond to your queries, submitted via the <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> Help Centre, within one business day.</li>
                <li><strong>Tier 3 (Business Plan):</strong> For our Business plan customers, we strive to respond to all support requests, submitted through the <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> Help Centre, within two business days.</li>
                <li><strong>Tier 4 (Professional Plan):</strong> If you're on our Professional plan, you can expect to receive a response within three business days after submitting a support request via the <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> Help Centre.</li>
              </ul>
            ...
            <section id="security" className="tos-section">
              <h2>Data Security</h2>
              <p>You understand and accept that <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> uses third party vendors and hosting partners to provide the necessary hardware, software, networking, storage, and related technology required to run the Services.</p>
              ...
              <p>For further details about the Data Security processes in place at <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a>, please contact our support team.</p>
            </section>
            <section id="contact" className="tos-section">
              ...
              <div className="tos-contact-info">
                ...
                <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a><br />
          ...
          <footer className="tos-footer">
            <p>
              For additional support or inquiries, please contact the <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a> support team.
            </p>
            <p className="copyright">
              &copy; 2025 <a href="https://geopulesforu.business/" target="_blank" rel="noopener noreferrer" className="geopulse-link">GeoPulse</a>. 1 Victoria Street, Bristol BS1 6AA, UK. All rights reserved.
            </p>
          </footer>
        </div>
      </div>
